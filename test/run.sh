...
DEFAULT_SUT_IMAGE="http-resource:sut"
TEST_IMAGE="http-resource-tests"
...
usage() {
    ...
    echo "  ${green}./run.sh${reset} -i http-resource:my-dev"
    echo ""
    echo "  ${blue}# run 'check' tests against a specific tag ${reset}"
    echo "  ${green}./run.sh${reset} -i http-resource:my-dev check"
    echo ""
    echo "  ${blue}# run 'check' and 'in' tests against a specific tag ${reset}"
    echo "  ${green}./run.sh${reset} -i http-resource:my-dev check in"
    echo ""
    echo "  ${blue}# open a shell into the test container built atop a specific tag ${reset}"
    echo "  ${green}./run.sh${reset} -i http-resource:my-dev shell"
    echo ""
